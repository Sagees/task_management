...
class AppData(DataSet):
    def __init__(self, params):
        ...
        :param params:
        '''
        super(AppData, self).__init__(params)
        self.feature_norm = FeatureNorm()

    def preprocess_data(self, data):
        data.columns = ['AppIdx', 'Start', 'End']
        return data
    ...
    def load_data(self, data_dir, skipfooter=0, parse_dates=None, date_parser=None):
        ...
        data = pd.read_csv(data_dir, names=['AppIdx', 'Start', 'End'], parse_dates=['Start'], dayfirst=True, infer_datetime_format=True, skiprows=1, skipfooter=skipfooter)
...
if __name__=='__main__':
    # data_dir = '../../data/trace/trace100.csv'
    #
    # prepare_data = AppData(params={'input_seq_length':15,'output_seq_length':5})
